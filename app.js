...
people.forEach(function(people){
	$list.append('<tr> <td>' + people.firstName + '</td><td>' + people.lastName + '\
		</td><td>' + people.phoneNumber + '</td><td><button class="btn btn-primary deleteTodo">done</button></td></tr>'
		)
});
...
function createNewPersonFromForm(event){
	...
	if(firstName && lastName && phoneNumber){
		...
		$list.append('<tr> <td>' + firstName + '</td><td>' + lastName + '\
			</td><td>' + phoneNumber + '</td><td><button class="btn btn-primary deleteTodo">done</button></td></tr>'
			)			
